...
int main (int argc, char* argv[]) {
  ...
  fftwf_plan_with_nthreads(dualres::internals::_N_THREADS_);
  std::cout << "[FFTW running on " << dualres::internals::_N_THREADS_
	    << " cores]\n";
  ...
  std::cout << "Done!\n\t(computation took " << std::setprecision(2) << std::fixed
